...
export default function HeaderDesktop() {
  ...
  return (
    <>
      {}
      <div>
        <div className="navbar bg-secondary h-12 xl:h-24 py-16 px-6 flex justify-between">
          <div className="flex justity-center items-center h-30">
            <a className=" btn btn-ghost w-32 h-24 text-xl">
              <img className="w-24 h-24" src={ffLogo} />
            </a>
            <div>
              <p className="text-3xl font-semibold text-darkbrown">
                Freshy Foodie
              </p>
              <p className="text-xl font-semibold text-darkbrown">
                Freshly Meet, Freshly Eat
              </p>
            </div>
          </div>
